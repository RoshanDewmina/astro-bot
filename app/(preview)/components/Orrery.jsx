...
const Orrery = () => {
    ...
    const [sliderValue, setSliderValue] = useState(5); // Slider value for the number of planets/comets to show
    ...
    useEffect(() => {
        fetch('/orbitalData.json')
            ...
            .then((data) => setOrbitalData(data)) // Load all data initially
    ...
    }, [orbitalData, sliderValue]); // Re-run effect when sliderValue changes
    ...
    return (
        <div>
            ...
            <div style={{ position: 'absolute', top: 20, left: 20, zIndex: 10 }}>
                <label style={{ color: 'white' }}>Number of Planets/Comets: {sliderValue}</label>
                <input
                    type="range"
                    min="1"
