...
export async function POST(req: Request) {
  ...
  const result = await streamText({
    ...
    Your purpose is to answer any questions related to space, planets, and the provided data with concise but accurate explanations, if a user asks about something related to astronomy, feel free to refer to the web if and only if that information is not in the data provided. Ask if the user would like more information at the end of your response.
