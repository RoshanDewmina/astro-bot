...
const Orrery = ()=>{
    ...
    const [sliderValue, setSliderValue] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(5); // Slider value for the number of planets/comets to show
    const planetSizes = {
        planet_Mercury: 0.38,
        planet_Venus: 0.95,
        planet_Earth: 1,
...
_s(Orrery, "kq7DeDbPVVR52IQicpxfLlu75fI=");
_c = Orrery;
